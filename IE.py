...
def get_toi_articles():
    ...
    for item in soup.find_all('h3')[:6]:  # Adjust class name 'ABC' based on actual structure
...
def get_article_content(link):
    try:
        ...
        article_body = soup.find_all('div', {'class': 'story_details'})
